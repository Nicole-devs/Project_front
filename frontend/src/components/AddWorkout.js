...
function AddWorkout({user}) {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`https://my-workout-space-backend.herokuapp.com/users/${user.id}`, configObj)
      .then((res) => res.json())
  ...
  return (
    ...
    <Box container sx={{ padding: "15px", m:2, border:1, height: "400px", width:"400px", borderRadius: 2 }}>
        ...
        <Typography sx={{ fontFamily: "Monospace", mb: 1 }} variant="h4" >Add New Workout</Typography>
